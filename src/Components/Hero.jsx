    ...
    <div data-bg="dark" className="h-256 w-full bg-teal-dark ">
      <div className="flex flex-col justify-between w-full h-full bg-[url('/hero-bg.png')] bg-cover bg-center pb-12.5 pt-55 xl:pt-56 2xl:pt-67.25 px-20">
        <div className="flex justify-between">
          <h1 className="text-[86px] font-semibold  text-white font-[Manrope] max-w-186.5 w-full tracking-tighter">Дом, в котором уютно с Любимым текстилем</h1>

          <p className="text-white mt-10 text-end max-w-115 w-full font-[Manrope]  font-normal text-[20px] tracking-tight">

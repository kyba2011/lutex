          ...
          <div className="flex text-teal-light mt-6 lg:mt-8 xl:mt-10 mb-8 lg:mb-10 xl:mb-12.5 font-semibold text-sm lg:text-base leading-tight gap-8 lg:gap-12 xl:gap-16">
            <div className="flex flex-col space-y-3 lg:space-y-4 xl:space-y-5">
              <p
                ...
                className={`cursor-pointer transition-colors ${selectedCategory === "Халаты"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
              ...
              <p
                ...
                className={`cursor-pointer transition-colors ${selectedCategory === "Сорочки"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
              ...
              <p
                ...
                className={`cursor-pointer transition-colors ${selectedCategory === "Пижамы"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
            ...
            <div className="flex flex-col space-y-3 lg:space-y-4 xl:space-y-5">
              <p
                ...
                className={`cursor-pointer transition-colors ${selectedCategory === "Туники"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
              ...
              <p
                ...
                className={`cursor-pointer transition-colors ${selectedCategory === "Толстовки"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
              ...
              <p
                ...
                className={`cursor-pointer transition-colors whitespace-nowrap ${selectedCategory === "Спортивные костюмы"
                    ? "text-[#D9B46C]"
                    : "hover:text-[#D9B46C]"
                  }`}
              >
